...
alias qwenbox='docker stop qwenbox 2>/dev/null || true && docker run -d --rm --name qwenbox -v $(find ~/code -maxdepth 1 -type d -not -path "*/archive" | fzf):/app --mount type=volume,source=qwen_config,target=/root/.qwen qwenbox'
